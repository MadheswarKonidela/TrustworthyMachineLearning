...
API_KEY = "7ac0b0cc7d5d1e6c8380088a58a60044"  # replace with your actual API key

MODEL_PATH = "/Users/madheswarkonidela/Downloads/model5.pt"  # replace with your actual model path
